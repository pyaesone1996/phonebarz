                ...
                <div class="col-lg-6">
                    <div class="product-order">
                        <div class="row product-order-detail">
                            <div class="col-3"><img src="/wp-content/uploads/2023/06/d1.jpg" alt=""
                                    class="img-fluid blur-up lazyload"></div>
                            <div class="col-3 order_detail">
                                <div>
                                    <h4>product name</h4>
                                    <h5>Wireless Bluetooth Headphone</h5>
                                </div>
                            </div>
                            <div class="col-3 order_detail">
                                <div>
                        ...
                        <div class="row product-order-detail">
                            <div class="col-3"><img src="/wp-content/uploads/2023/06/p6.jpg" alt=""
                                    class="img-fluid blur-up lazyload"></div>
                            <div class="col-3 order_detail">
                                <div>
                                    <h4>product name</h4>
