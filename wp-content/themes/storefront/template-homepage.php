						...
						<a href="#">
							<div class="collection-banner tl-content">
								<div class="img-part custom-height">
									<img src="/wp-content/uploads/2023/06/banner1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
								</div>
							...
							<div class="row">
								<div class="col-12 mb-4">
									<a href="#">
										<div class="collection-banner">
											<div class="img-part">
												<img src="/wp-content/uploads/2023/06/banner2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
											</div>
											<div class="contain-banner banner-3">
												<div>
													<h2>laptops</h2>
								...
								<div class="col-12">
									<a href="#">
										<div class="collection-banner">
											<div class="img-part">
												<img src="/wp-content/uploads/2023/06/banner3.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
											</div>
											<div class="contain-banner banner-3">
												<div>
													<h2>phones</h2>
				...
				<div class="col-lg-3 col-12 d-lg-block d-none">
					<div class="banner-goggles banner-padding pt-0">
						<a href="#">
							<div class="collection-banner tl-content">
								<div class="img-part custom-height">
									<img src="/wp-content/uploads/2023/06/banner4.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
								</div>
								<div class="contain-banner banner-3">
									<div>
										<h2>accessories</h2>
...
<!-- slider and product -->
<div class="product-banner" style="background-image: url(/wp-content/uploads/2023/06/fashion-bg.webp); background-size: cover; background-position: center center; display: block;">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<div class="product-text text-center">
					<h3>Smart Fashion</h3>
					<h2>With Smart Devices</h2>
					<div class="shop-btn-wrap">
						<a href="" class="shop-btn" title="">SHOP ALL DEVICES</a>
					</div>
...
<section class="container">
	<div class="full-banner small-banner text-center p-center">
		<img src="/wp-content/uploads/2023/06/banner.jpg" alt="" class="bg-img blur-up lazyload">
		<div class="container">
			<div class="row">
				<div class="col">
		...
		<div class="row partition2">
			<div class="col-md-6">
				<a href="#">
					<div class="collection-banner p-right text-center">
						<div class="img-part">
							<img src="/wp-content/uploads/2023/06/watch.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
						</div>
			...
			<div class="col-md-6">
				<a href="#">
					<div class="collection-banner p-right text-center">
						<div class="img-part">
							<img src="/wp-content/uploads/2023/06/speaker.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
						</div>
						<div class="contain-banner">
							<div>
								<h4>save 60%</h4>
						...
						<!-- <div id="tab-4" class="tab-content active default">
                            <div class="no-slider five-product row">
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="/wp-content/uploads/2023/06/p1.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                ...
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="/wp-content/uploads/2023/06/p2.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-box style-1 rounded-0">
                                            <button onclick="openCart()" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="/wp-content/uploads/2023/06/p3.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-box style-1 rounded-0">
                                            <button onclick="openCart()" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="/wp-content/uploads/2023/06/p4.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-box style-1 rounded-0">
                                            <button onclick="openCart()" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="/wp-content/uploads/2023/06/p5.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-box style-1 rounded-0">
                                            <button onclick="openCart()" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="/wp-content/uploads/2023/06/p6.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-box style-1 rounded-0">
                                            <button onclick="openCart()" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="/wp-content/uploads/2023/06/p7.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-box style-1 rounded-0">
                                            <button onclick="openCart()" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box product-wrap">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="/wp-content/uploads/2023/06/p8.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                        </div>
                                        <div class="cart-box style-1 rounded-0">
                                            <button onclick="openCart()" title="Add to cart"><i class="ti-shopping-cart"></i></button>
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
											...
											<div class="img-wrapper">
												<div class="front">
													<a href="<?php echo $product_permalink; ?>">
														<img src="<?php echo $product_image; ?>" class="img-fluid blur-up lazyload bg-img" alt="<?php echo $product_title; ?>">
													</a>
												</div>
